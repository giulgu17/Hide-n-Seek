execute if score seekerOnDeath hiddenInfo matches 1 run title @s[team=!Seekers] title {"text":"You are a SEEKER!","color":"red"}
execute if score seekerOnDeath hiddenInfo matches 1 run title @s[team=!Seekers] subtitle {"text":"Kill all hiders","color":"white"}
