...
execute if score autoSeekerPicker hiddenInfo matches 1 if score Lobby hiddenInfo < #Two hiddenInfo run return run tellraw @a {"text":"Error: not enough players to start the game.","color":"red"}
